...
<?php get_template_part('partials/section-baner', null, ['bg' => '/wp-content/themes/beawesome/img/bg-small-2.webp']); ?>
            ...
            while ($posts_query->have_posts()):
                ...
                <article>
                    <a href="<?php the_permalink(); ?>" class="flex mb-2">
                        ...
                        <?php else: ?>
                            <img src="/wp-content/themes/beawesome/img/spotkanie.png"
                                class="w-full <?php echo $image_height; ?> rounded-lg object-cover" alt="<?php the_title(); ?>">
                        <?php endif; ?>
                    </a>
                    <div>
