            ...
            <div>
                ...
                if (!empty($phone)):
                    ...
                    <div class="flex items-center gap-6">
                        <svg class="w-14 h-14" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                            width="60.923" height="60.923" viewBox="0 0 60.923 60.923">
                            <defs>
                                <clipPath id="clip-path">
                                    <rect id="Rectangle_17879" data-name="Rectangle 17879" width="60.923" height="60.923"
                                        fill="none" />
                                </clipPath>
                            </defs>
                        ...
                        <div>
                            ...
                            <p class="my-0">
                                <a href="tel:+48<?php echo esc_attr($phone_clean); ?>">
                ...
                <div class="flex items-center gap-6">
                    <svg class="w-14 h-14" xmlns="http://www.w3.org/2000/svg" width="60.923" height="60.923"
                        ...
                        <g id="Group_42756" data-name="Group 42756" transform="translate(-139.439 -928.077)">
                            ...
                            <g id="icon" transform="translate(154.758 946.983)">
                                ...
                                <path id="Path_852" data-name="Path 852" d="M142.59,167.781l13.393,11.3,13.811-11.491"
                    ...
                    <div>
                        ...
                        <p class="my-0"><a href="mailto:<?php the_field('email'); ?>"><?php the_field('email'); ?></a>
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-6">
                    <svg class="w-14 h-14" data-name="Group 42713" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <defs>
                            <clipPath id="clip-path">
                                <rect id="Rectangle_17881" data-name="Rectangle 17881" width="60.983" height="60.983"
                                    fill="none" />
                            </clipPath>
                        </defs>
